self.props = {
    ...
    assets_url: 'https://raw.githubusercontent.com/jinoo2005609/google-drive-index-worker/master/assets',
    discord_invite: ''
};
(function () {
    'use strict';
    ...
    var jwt = createCommonjsModule(function (module, exports) {
        ...
        const getHeader = (alg, headerAdditions) => ({
            ...headerAdditions,
            alg,
            typ: 'JWT'
...
<html lang="en">
    <head>
        ...
        <title>${path} | ${self.props.title}</title>
        <meta name="description" content="${self.props.description}">
        ...
        <link rel="apple-touch-icon" sizes="120x120" href="${self.props.assets_url}/apple-touch-icon.png">
        <link rel="icon" type="image/png" sizes="32x32" href="${self.props.assets_url}/favicon-32x32.png">
        <link rel="icon" type="image/png" sizes="16x16" href="${self.props.assets_url}/favicon-16x16.png">
        <link rel="manifest" href="${self.props.assets_url}/manifest.json">
        <link rel="mask-icon" href="${self.props.assets_url}/safari-pinned-tab.svg" color="#5bbad5">
        <meta name="msapplication-TileColor" content="#ffc40d">
        <meta name="theme-color" content="#ffffff">

        <link rel="stylesheet" href="${self.props.assets_url}/css/style.css">
        <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/fomantic-ui@2.8.7/dist/semantic.min.css">
        <script src="${self.props.assets_url}/js/cookie.js"></script>
        <script src="${self.props.assets_url}/js/darkmode.js"></script>
    ...
    <body>
        ...
        <div class="pusher">
            <div class="background container">
                <h1 class="ui inverted center aligned header">${self.props.title}</h1>
        ...
        <script>
            var discordInvite = '${self.props.discord_invite}';
        </script>
        <script src="${self.props.assets_url}/js/footer.js"></script>
        <script src="${self.props.assets_url}/js/header.js"></script>
        <script src="${self.props.assets_url}/js/metadata.js"></script>
        <script src="${self.props.assets_url}/js/sidebar.js"></script>
        <script>
